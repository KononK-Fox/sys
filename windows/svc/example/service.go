...
import (
	...
	"github.com/kononk-fox/sys/windows/svc/debug"
	"github.com/kononk-fox/sys/windows/svc/eventlog"
)
	...
	for {
		...
		case c := <-r:
			...
			case svc.Stop, svc.Shutdown:
				// github.com/kononk-fox/sys/windows/svc.TestExample is verifying this output.
